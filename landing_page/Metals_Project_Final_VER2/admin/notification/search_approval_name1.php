...
<body>
           ...
           <select class="form-control" name="forwardname" id="forwardname">
                 ...
                 $listseque=" SELECT * FROM XX_QUOTE_APPROVAL_LIST_ALL WHERE QUOTE_HEADER_ID ='".$QUOTE_HEADER_ID."' AND EMPLOYEE_ID='".$A_NAME."' ORDER BY SEQUENCE_NO ASC ";
                    ...
                    AND EMPLOYEE_ID NOT IN (SELECT a.EMPLOYEE_ID FROM XX_QUOTE_APPROVAL_LIST_ALL a  WHERE  a.QUOTE_HEADER_ID='".$listseque12['QUOTE_HEADER_ID']."' AND a.SEQUENCE_NO='".$listseque12['SEQUENCE_NO']."' OR a.QUOTE_HEADER_ID='".$listseque12['QUOTE_HEADER_ID']."'
                    AND a.PERFORM_ACTIVITY_TYPE_CODE='N')
                    ORDER BY EMPLOYEE_ID ASC";



                // $forward="SELECT distinct(b.EMPLOYEE_ID),b.DESIGNATION,b.FULL_NAME from XX_APPROVAL_MEMBER_V b
                //                 WHERE FULL_NAME LIKE '%".$APPROVAL_NAME."%' AND b.EMPLOYEE_ID NOT IN (SELECT a.EMPLOYEE_ID FROM XX_QUOTE_APPROVAL_LIST_ALL a  WHERE  a.QUOTE_HEADER_ID='".$listseque12['QUOTE_HEADER_ID']."' AND a.SEQUENCE_NO='".$listseque12['SEQUENCE_NO']."' OR a.QUOTE_HEADER_ID='".$listseque12['QUOTE_HEADER_ID']."' AND a.PERFORM_ACTIVITY_TYPE_CODE='N') ORDER BY b.EMPLOYEE_ID ASC";
