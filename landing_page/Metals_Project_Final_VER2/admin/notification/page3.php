    ...
    <tr>
      <td>
        <div class="input-group">
          ...
          <input type="text" id="dp_amount_script" value="<?php echo $resultCheck1['DP_AMOUNT']; ?>" class="form-control" disabled>
        </div>
      </td>
    ...
    <tr>
      ...
      <td>
        <div class="input-group">
          ...
          <?php  ?>
            <input type="text" value="<?php echo $resultCheck1['DP_PERCENT']; ?>%" id="dp_percent_script" class="form-control" disabled>
        </div>
      </td>
    ...
    <tr>
      <td>
        <div class="input-group">
          ...
          <input type="text" id="no_of_intallment_script" value="<?php echo $resultCheck1['NO_OF_INSTALLMENT']; ?>" class="form-control" disabled>
        </div>
      </td>
          ...
          <div class="input-group-prepend">
            <span class="input-group-text" id="">Discount</span>
             ...
             <!-- End % TK -->
               ...
               <input type="text"  id="discount_value_script" value="<?php echo $resultCheck1['DISCOUNT_VALUE']; ?>" class="form-control" placeholder="" disabled>
    ...
    <tr>
      <td>
        <div class="input-group">
          ...
          <input type="text" id="no_of_free_installment_script" value="<?php echo $resultCheck1['NO_OF_FREE_INSTALLMENT']; ?>" class="form-control" disabled>
        </div>
      </td>
    ...
    <tr>
      <td>
        <div class="input-group">
          ...
          <input type="text" id="remarks_script" value="<?php echo $resultCheck1['REMARKS']; ?>" class="form-control" disabled>
        </div>
      </td>
...
<?php
  ...
  ?>
           ...
           <input type="hidden" class="Unit_list_Price_indiM" value="<?php echo $UNIT_LIST_PRPICE; ?>">
           <input type="hidden" class="$quantiy_indiM" value="<?php echo $quantiy; ?>">
 ...
 <input type="hidden" name="" id="Column1" value="<?php echo $column; ?>">
...
<?php endwhile; ?>
  ...
  <br>
        ...
        <table border="0" style="" align="center" width="65%">
   ...
   <form method="post" action="insert.php">
        <td>
          <div class="input-group ">
           ...
           <output name="result" class="form-control " readonly><?php echo $resultCheck1['DP_AMOUNT']; echo "&nbsp;"; echo "($DP_Parcent2%)"; ?></output>
             <!-- <output name="result" class="form-control " readonly><?php echo $resultCheck1['DP_AMOUNT']; ?></output> -->
            <input type="hidden" class="form-control" value="<?php echo $resultCheck1['DP_AMOUNT']; ?>" name="DP_AMOUNT"  >
          </div>
        </td>
      ...
      <tr>
        ...
        <td>
          <div class="input-group">
            ...
            <input type="hidden" class="form-control" value="<?php echo $resultCheck1['NO_OF_INSTALLMENT']; ?>" name="NO_OF_INSTALLMENT"  >
          </div>
        </td>
      ...
      <tr>
        ...
        <td>
          <div class="input-group">
            ...
            <input type="hidden" class="form-control" value="<?php echo $resultCheck1['DISCOUNT_VALUE']; ?>" name="DISCOUNT_VALUE"  >
          </div>
        </td>
 ...
 <input type="hidden" name="NAME" id="NAME" value="<?php echo $A_NAME; ?>">
        ...
        <td>
          <div class="input-group">
            ...
            <input type="hidden" class="form-control" value="<?php echo $resultCheck1['NO_OF_FREE_INSTALLMENT']; ?>"name="NO_OF_FREE_INSTALLMENT" >
          </div>
      ...
      <tr>
        ...
        <td>
          <div class="input-group">
            ...
            <!-- <input type="hidden" class="form-control" name="REMARKS" value="<?php echo $resultCheck1['REMARKS']; ?>" > -->
  ...
  <table border="0" style="" align="center" width="65%" >
    ...
    <tr>
      ...
      <td rowspan="5">
        ...
        <span><input id="" type="text" style="Color:maroon;" class="form-control x" value="YOU-> (<?php echo $FULL_NAME[0]; ; ?>)" name="NAME" id="NAME" disabled></span>
      ...
      <td>
               ...
               <output name="result" class="form-control" value="<?php echo $resultCheck1['DP_AMOUNT']; ?>" id="DP_AMOUNT2" readonly></output>

               <input type="hidden" class="form-control" value="<?php echo $resultCheck1['DP_AMOUNT']; ?>" name="DP_AMOUNT" id="DP_AMOUNT" >
               </div>
             </td>
           ...
           <tr>
             ...
             <td>
               <div class="input-group">
                 ...
                 <output name="result" class="form-control"  value="<?php echo $resultCheck1['NO_OF_INSTALLMENT']; ?>" id="NO_OF_INSTALLMENT2" readonly ></output>
                 <input type="hidden" class="form-control" value="<?php echo $resultCheck1['NO_OF_INSTALLMENT']; ?>" name="NO_OF_INSTALLMENT" id="NO_OF_INSTALLMENT" >
               </div>
             </td>
           ...
           <tr>
             ...
             <td>
               <div class="input-group">
                 ...
                 <!-- <input type="text" class="form-control" name="DISCOUNT_VALUE" id="DISCOUNT_VALUE" placeholder="5000 Tk." disabled> -->
                      <input type="text"  name="result" class="formy" value="<?php echo $resultCheck1['DISCOUNT_VALUE']; ?>" id="DISCOUNT_VALUE2" disabled>
                 ...
                 <input type="hidden" class="form-control" value="<?php echo $resultCheck1['DISCOUNT_VALUE']; ?>" name="DISCOUNT_VALUE" id="DISCOUNT_VALUE" >
               </div>
             </td>
      ...
      <input type="hidden" name="NAME" id="NAME" value="<?php echo $A_NAME; ?>">
             ...
             <td>
               <div class="input-group">
                 ...
                 <!-- <input type="text" class="form-control" name="NO_OF_FREE_INSTALLMENT" id="NO_OF_FREE_INSTALLMENT" placeholder="3" disabled> -->
                  <output name="result" class="form-control" value="<?php echo $resultCheck1['NO_OF_FREE_INSTALLMENT']; ?>" id="NO_OF_FREE_INSTALLMENT2" readonly></output>
                 <input type="hidden" class="form-control" value="<?php echo $resultCheck1['NO_OF_FREE_INSTALLMENT']; ?>" name="NO_OF_FREE_INSTALLMENT" id="NO_OF_FREE_INSTALLMENT">
               </div>
           ...
           <tr>
              ...
              <td>
               <div class="input-group">
                 ...
                 <!-- <input type="text" class="form-control" name="REMARKS" id="REMARKS" placeholder="" disabled> -->
                        <output name="result"  class="form-control" value="<?php echo $resultCheck1['REMARKS']; ?>" id="REMARKS2" readonly></output>
                 <input type="hidden" class="form-control" value="<?php echo $resultCheck1['REMARKS']; ?>" name="REMARKS" value=""id="REMARKS" >
               </div>
             </td>
...
<button type="submit"  name="Suppfinal" id="button2" value="Suppfinal" class="btn btn-primary"  width="100%" style="margin-left:60%;">Approved</button>
</p>
...
<button type="submit"  name="Suppfinal" id="button2" value="Suppfinal" class="btn btn-primary"  width="100%" style="margin-left:60%;">Supported</button>
</p>
...
$find_perform="SELECT * FROM XX_QUOTE_APPROVAL_LIST_ALL WHERE QUOTE_HEADER_ID='".$QUOTE_HEADER_ID."' OR QUOTE_HEADER_ID='".$QUOTE_HEADER_ID2."'";
...
if ($PERFORM_ACTIVITY_TYPE_CODE_PROOF[$T-1]=='F')
{
...
else
{
 ...
 ?>
  <!-- Forward -->
    ...
    <form class="" style="margin-top:12px;" onsubmit="return Validate()" action="../notification/forward.php" method="post">
    ...
    <br>
        <table border="0" style="max-width:97%;" align="center">
          ...
          <input type="hidden" class="form-control" id="DP_AMOUNT_FORWARD_INPUT" value="<?php echo $resultCheck1['DP_AMOUNT']; ?>" name="DP_AMOUNT"  >
          <input type="hidden" class="form-control" id="NO_OF_INSTALLMENT_FORWARD_INPUT" value="<?php echo $resultCheck1['NO_OF_INSTALLMENT'];?>" name="NO_OF_INSTALLMENT"  >
          <input type="hidden" class="form-control" id="DISCOUNT_VALUE_FORWARD_INPUT" value="<?php echo $resultCheck1['DISCOUNT_VALUE'];  ?>" name="DISCOUNT_VALUE"  >
          <input type="hidden" class="form-control" id="NO_OF_FREE_INSTALLMENT_FORWARD_INPUT" value="<?php echo $resultCheck1['NO_OF_FREE_INSTALLMENT']; ?>"name="NO_OF_FREE_INSTALLMENT">
           ...
           $listseque=" SELECT * FROM XX_QUOTE_APPROVAL_LIST_ALL WHERE QUOTE_HEADER_ID = '".$QUOTE_HEADER_ID."' AND EMPLOYEE_ID='".$A_NAME."' OR QUOTE_HEADER_ID = '".$QUOTE_HEADER_ID2."' AND EMPLOYEE_ID='".$A_NAME."' ORDER BY SEQUENCE_NO ASC ";

           $listseque1 = oci_parse($conn,$listseque);
           oci_execute($listseque1);
           $listseque12 =oci_fetch_array($listseque1,OCI_ASSOC);
...
<br>
    ...
    <span class="input-group-text" >Comments :
        ...
        <input type="text" class="form-control" id="REMARKS_FORWARD_INPUT" name="REMARKS" value="" >
    </div>
         ...
         <button type="button" id="hide" onclick="hide2()" class="btn btn-secondary">Hide</button>
             <button style="margin-left:57%;" width="100%" type="submit" value="forward" name="forward" class="btn btn-success">Submit</button>
             <br>
           </form>
       </div>
         </div>
        ...
        <table border="0" style="" align="center" width="50%">
          ...
          <tr>
            <td>
                     ...
                     <input type="text" class="form-control" value="<?php echo $resultCheck1['DP_AMOUNT']; ?>"  id="DP_AMOUNT1" >
                   ...
                   <td>
                     <div class="input-group">
                       ...
                       <select name="cars" class="form-control" id="NO_OF_INSTALLMENT1">
                           ...
                           <option style="background-color:white;color:white;" value="<?php echo $resultCheck1['NO_OF_INSTALLMENT']; ?>"><?php echo $resultCheck1['NO_OF_INSTALLMENT']; ?></option>
                           <?php
                 ...
                 <tr>
                   ...
                   <td>
                     <div class="input-group">
                       ...
                       <input type="text" class="form-control" value="<?php echo $resultCheck1['DISCOUNT_VALUE']; ?>"  id="DISCOUNT_VALUE1" >
                   ...
                   <td>
                     <div class="input-group">
                       ...
                       <select name="cars" class="form-control" id="NO_OF_FREE_INSTALLMENT1">
                           ...
                           <option style="background-color:white;color:white;" value="<?php echo $resultCheck1['NO_OF_FREE_INSTALLMENT']; ?>"><?php echo $resultCheck1['NO_OF_FREE_INSTALLMENT']; ?></option>
                           <?php
                 ...
                 <tr>
                   ...
                   <td>
                     <div class="input-group">
                       ...
                       <!-- <input type="text" class="form-control" value="<?php echo $resultCheck1['REMARKS']; ?>" id="REMARKS1" > -->
