...
$DP_PERCENT = $dp_percent_acurate;

$ACTUAL_DP_AMOUNT = $actual_dp_amount_acc;
...
$Monthly_Installment_Amount = $Total_Installment_Amount / $no_installment;  //no_installment HOW MUCH WILL IT BE?
