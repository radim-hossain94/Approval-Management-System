...
WHERE HA.CREATED_BY = '".$_SESSION['u_id']."' AND QUOTE_STATUS= 'APPROVED' AND HA.QUOTE_NAME LIKE '%".$QUOTE_NAME."%' OR
HA.CREATED_BY = '".$_SESSION['u_id']."' AND QUOTE_STATUS= 'REJECTED' AND HA.QUOTE_NAME LIKE '%".$QUOTE_NAME."%' OR
HA.CREATED_BY = '".$_SESSION['u_id']."' AND QUOTE_STATUS= 'DRAFT' AND HA.QUOTE_NAME LIKE '%".$QUOTE_NAME."%' OR
HA.CREATED_BY = '".$_SESSION['u_id']."' AND QUOTE_STATUS = 'PENDING' AND HA.QUOTE_NAME LIKE '%".$QUOTE_NAME."%'  ";
