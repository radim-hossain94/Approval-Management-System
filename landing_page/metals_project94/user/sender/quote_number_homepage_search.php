...
$query = "select HA.ASSESSMENT_NUMBER,
  ...
  WHERE HA.CREATED_BY = '".$_SESSION['u_id']."' AND QUOTE_STATUS= 'APPROVED' AND HA.QUOTE_NUMBER LIKE '%".$QUOTE_NUMBER."%' OR
  HA.CREATED_BY = '".$_SESSION['u_id']."' AND QUOTE_STATUS= 'REJECTED' AND HA.QUOTE_NUMBER LIKE '%".$QUOTE_NUMBER."%' OR
  HA.CREATED_BY = '".$_SESSION['u_id']."' AND QUOTE_STATUS= 'DRAFT' AND HA.QUOTE_NUMBER LIKE '%".$QUOTE_NUMBER."%' OR
  HA.CREATED_BY = '".$_SESSION['u_id']."' AND QUOTE_STATUS = 'PENDING' AND HA.QUOTE_NUMBER LIKE '%".$QUOTE_NUMBER."%' ";
