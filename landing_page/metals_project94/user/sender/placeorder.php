    ...
    <tr >
      <td>
        <div class="input-group">
          ...
          <input type="text" value="<?php echo $resultCheck['APPLICANT_NAME']; ?>" class="form-control" disabled>
        </div>
      </td>
...
$employee_name = oci_fetch_array($Employee_name_result,OCI_ASSOC);
  ...
  <br>
  <p>
  <a href="cancel.inc.php?ASSESSMENT_NUMBER=<?php echo $ASSESSMENT_NUMBER; ?>"><button align="" type="button" class="btn btn-primary" id="button1">Canceled</button></a>
  <a href="placeorder.inc.php?ASSESSMENT_NUMBER=<?php echo $ASSESSMENT_NUMBER; ?>"><button align="" type="button" class="btn btn-primary" id="button2">Place Order</button></a>
  </p>
